...
export const CameraIcon = ({ className }: IconProps): React.ReactNode => (
...
export const StopCircleIcon = ({ className }: IconProps): React.ReactNode => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const EyeIcon = ({ className }: IconProps): React.ReactNode => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
